...
try
  ...
  (* let asts =[Applic'
  (LambdaSimple' (["factorial"],
    Seq'
     [Set'  (VarParam ("factorial", 0), Box' (VarParam ("factorial", 0)));
      Seq'
       [BoxSet' (VarParam ("factorial", 0),
         LambdaSimple' (["x"],
          If'
           (Applic' (Var' (VarFree "="),
           ...
           ApplicTP' (Var' (VarFree "*"),
            [Applic' (BoxGet' (VarBound ("factorial", 0, 0)),
              [Applic' (Var' (VarFree "+"),
                [Var' (VarParam ("x", 0)); Const' (Sexpr (Number (Fraction (-1,1))))])]);
             Var' (VarParam ("x", 0))]))));
        ApplicTP' (BoxGet' (VarParam ("factorial", 0)),
         [Const' (Sexpr (Number (Fraction (2,1))))])]]),
  [Const' (Sexpr (Symbol "whatever"))])] in
    *)
